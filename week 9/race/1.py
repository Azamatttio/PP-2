...
car_Enemy = pygame.image.load("python/images1/car1.png")
car_Own = pygame.image.load("python/images1/car1.png")
bg = pygame.image.load("python/images1/bg.png")
...
class coin_generation(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.img = pygame.transform.scale(pygame.image.load('python/images1/coin.png'), (60//self.weight,60//self.weight))
...
class ownMovement(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.car = pygame.transform.scale(pygame.image.load('python/images1/car1.png'), (50,70))
...
class enemyMovement(pygame.sprite.Sprite):
        def __init__(self):
            super().__init__()
            self.car = pygame.transform.scale(pygame.image.load('python/images1/car1.png'), (45, 90))
            self.rect = self.car.get_rect()
